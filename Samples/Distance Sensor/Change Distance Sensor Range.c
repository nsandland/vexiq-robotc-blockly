...
<xml xmlns="https://developers.google.com/blockly/xml">
  ...
  <block type="vex_iq_brain" id="(^W84*BmMq_oQZrg1R28" x="13" y="38">
  ...
  <block type="events_on_start" id=")LZQbUvmq55?Gk$Q71z3" x="13" y="413">
    <statement name="DO">
  ...
  <block type="events_always" id="%Pwmj?;Y8gwY*F8Z$#WM" x="13" y="563">
    <statement name="DO">
