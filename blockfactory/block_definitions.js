...
Blockly.Blocks['vex_iq_brain'] = {
  init: function() {
    ...
    this.appendValueInput("PORT_1")
        ...
        .appendField(new Blockly.FieldVariable("port_1"), "PORT_1_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_2")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 2 named")
        .appendField(new Blockly.FieldVariable("port_2"), "PORT_2_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_3")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 3 named")
        .appendField(new Blockly.FieldVariable("port_3"), "PORT_3_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_4")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 4 named")
        .appendField(new Blockly.FieldVariable("port_4"), "PORT_4_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_5")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 5 named")
        .appendField(new Blockly.FieldVariable("port_5"), "PORT_5_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_6")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 6 named")
        .appendField(new Blockly.FieldVariable("port_6"), "PORT_6_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_7")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 7 named")
        .appendField(new Blockly.FieldVariable("port_7"), "PORT_7_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_8")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 8 named")
        .appendField(new Blockly.FieldVariable("port_8"), "PORT_8_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_9")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 9 named")
        .appendField(new Blockly.FieldVariable("port_9"), "PORT_9_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_10")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 10 named")
        .appendField(new Blockly.FieldVariable("port_10"), "PORT_10_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_11")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 11 named")
        .appendField(new Blockly.FieldVariable("port_11"), "PORT_11_NAME")
        .appendField("has a");
    this.appendValueInput("PORT_12")
        .setCheck(["BumperDeclaration", "MotorDeclaration", "TouchLEDDeclaration", "ColorSensorDeclaration", "DistanceSensorDeclaration", "GyroDeclaration"])
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("port 12 named")
        .appendField(new Blockly.FieldVariable("port_12"), "PORT_12_NAME")
        .appendField("has a");
    this.setInputsInline(false);
    this.setColour(65);
 this.setTooltip("");
